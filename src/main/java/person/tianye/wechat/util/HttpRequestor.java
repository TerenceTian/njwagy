...
public class HttpRequestor {
	 ...
	 * @throws Exception
	 */
	public static String doPost(String url, Map parameterMap, String data) throws Exception {
		...
		try {
			...
			outputStreamWriter.write(parameterBuffer.toString()+data);
